...
public class TrkConverterTest {
  ...
  private static final TrkToTrkTypeConverter trkConverter
      = new TrkToTrkTypeConverter(TestConfig.getJaxbContextBuilder());

  private static final TrkTypeToTrkConverter trkTypeConverter
      = new TrkTypeToTrkConverter(TestConfig.getJaxbContextBuilder());
  ...
  public void convert() throws Exception {
    ...
    trk.getProperties().setAccessControl(new AccessControl());
