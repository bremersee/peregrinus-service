...
public class WptConverterTest {
  ...
  private static final WptToWptTypeConverter wptConverter = new WptToWptTypeConverter(
      TestConfig.getJaxbContextBuilder());

  private static final WptTypeToWptConverter wptTypeConverter = new WptTypeToWptConverter(
      TestConfig.getJaxbContextBuilder());
  ...
  public void convert() throws Exception {
    ...
    wptConverter.getJaxbContextBuilder().buildMarshaller().marshal(gpx, System.out);
