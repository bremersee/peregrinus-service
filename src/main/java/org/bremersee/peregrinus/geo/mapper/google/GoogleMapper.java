...
public interface GoogleMapper {
  ...
  @NotNull
  GeocodingRequest mapToGeocodeRequest(@NotNull GeoCodingQueryRequest source);

  @NotNull
  GeoCodingResult mapToGeoCodingResult(@NotNull GeocodingResult source);

  @Nullable
  Address mapToAddress(
      final @Nullable Collection<? extends AddressComponent> source,
      final @Nullable String formattedAddress);
