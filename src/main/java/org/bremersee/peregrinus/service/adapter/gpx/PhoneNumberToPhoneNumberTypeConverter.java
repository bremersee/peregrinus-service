...
/**
 * The phone number to gpx phone number type converter.
 *
...
class PhoneNumberToPhoneNumberTypeConverter {
  ...
  /**
   * Converts a phone number into a gpx phone number.
   *
   * @param <T>                 the gpx phone number type (can be
   *                            {@code org.bremersee.gpx.gpx.v3.model.ext.PhoneNumberT}
   *                            or {@code org.bremersee.gpx.waypoint.v1.model.ext.PhoneNumberT})
   * @param phoneNumber         the phone number
   * @param phoneNumberSupplier the gpx phone number supplier
   * @return the gpx phone number
   */
