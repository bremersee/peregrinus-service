...
public class BranchEntitySettingsReadConverter
  ...
  BranchEntitySettingsReadConverter(
    ...
    nodeSettingsConverter = new NodeEntitySettingsReadConverter(applicationContext);
  }

  @Override
  public BranchEntitySettings convert(Document document) {
    return (BranchEntitySettings) nodeSettingsConverter.convert(document);
  }
